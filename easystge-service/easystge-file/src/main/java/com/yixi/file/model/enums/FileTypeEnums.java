...
public enum FileTypeEnums {
    ...
    MUSIC(FileCategoryEnums.AUDIO, 2, new String[]{"mp3", "wav", "wma", "mp2", "flac", "midi", "ra", "ape", "aac", "cda"}, "音频"),
    ...
    PROGRAME(FileCategoryEnums.OTHER, 8, new String[]{"h", "c", "hpp", "hxx", "cpp", "cc", "c++", "cxx", "m", "o", "s", "dll", "cs",
